...
//     style={{backgroundImage: `url(${heroBg.src})` , backgroundPosition: "center" , backgroundSize: "cover" , backgroundRepeat: "no-repeat", minHeight: "120vh",aspectRatio: '16/9' }}
//     >
//       {/* Background Glow */}
...
export function HeroStats({
  ...
  return (
    <section
      className="relative z-10 overflow-hidden  aspect-[16/19] md:aspect-[16/9] "
      style={{
    ...
    >
      ...
      <div className="relative h-full w-full pt-6 pb-12 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center w-full">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pr-4">
            <h1 className="font-serif-display text-xl sm:text-xl lg:text-[3.5rem] font-medium text-white leading-[1.12] tracking-tight mt-42">
              Your Dream Career <br />
              Deserves the Right <br />
              <span className="gold-gradient-text font-serif-display italic font-semibold">
                Qualification.
