...
//   { name: "facebook", href: "https://facebook.com/mercuryacademy" },
//   { name: "instagram", href: "https://instagram.com/mercuryacademy" },
//   { name: "linkedin", href: "https://linkedin.com/company/mercuryacademy" },
//   { name: "youtube", href: "https://youtube.com/mercuryacademy" },
// ];
...
//   // Map footer navigation items with icons for Explore section
//   const exploreLinksWithIcons: ExploreLink[] = footerNavigation.explore.map(
//     (item) => {
...
//   return (
//     <footer className="w-full bg-[#020917] text-slate-200 border-t border-amber-500/20">
//       <Container className="pt-14 pb-8">
//         {/* Main 4-Column Footer Grid */}
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12">
//           {/* Column 1: Brand Logo, Description & Social Icons (Col-span 4) */}
...
//             <h3 className="font-serif text-xl font-bold tracking-wider text-white uppercase mt-2">
//               MERCURY ACADEMY
//             </h3>
...
//               Explore recognized universities, compare online and distance
//               courses, and receive complete admission guidance to shape your
//               future.
//             </p>
...
//                   className="w-10 h-10 rounded-full border border-amber-500/30 bg-[#07132a] flex items-center justify-center text-amber-400 hover:bg-amber-500/20 hover:border-amber-400 transition-all shadow-sm"
//                 >
...
//               {exploreLinksWithIcons.map((item) => {
...
//               <Link
//                 href="/contact"
//                 className="w-9 h-9 rounded-full bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 flex items-center justify-center text-[#020917] font-bold shadow-md transition-all hover:scale-105"
