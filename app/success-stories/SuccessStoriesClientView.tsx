      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-slate-100">
        ...
        <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-md px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">Success Story</p>
              <p className="text-sm font-semibold text-[#0A1931]">{story.name}</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* <div className="pt-6 flex items-center gap-6 text-xs font-semibold text-slate-500 border-t border-slate-200/60 max-w-lg">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-emerald-100">UGC Entitled Degrees</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-amber-900"></span>
                <span className="text-amber-100">NAAC A++ Accreditations</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                <span className="text-blue-100">Global Alumni Network</span>
              </div>
            </div> */}
          </div>
