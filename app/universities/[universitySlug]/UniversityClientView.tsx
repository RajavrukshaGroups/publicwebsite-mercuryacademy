...
//       <section className="relative bg-[#071938] text-white -mt-24.5 pt-10 pb-16 overflow-hidden h-[110vh]  aspect-[16/19] md:aspect-[16/9]"
              ...
              <div className="bg-white/95 backdrop-blur-sm text-slate-900 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-2xl border border-slate-200/80">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleEnquirySubmit} className="space-y-2 sm:space-y-2.5 md:space-y-3">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-[#FFB800] hover:bg-amber-400 text-slate-950 font-black text-[10px] sm:text-xs uppercase tracking-wider py-2.5 sm:py-3 rounded-md shadow-md transition-all cursor-pointer mt-0.5 sm:mt-1"
                    >
                      Submit Enquiry
                    </button>
