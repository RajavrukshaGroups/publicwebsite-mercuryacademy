...
//         <svg
//           className="absolute top-0 right-0 w-[900px] h-[700px] text-blue-900/10 opacity-70"
//           viewBox="0 0 800 600"
//           fill="none"
...
//         {/* HERO SECTION */}
//         <section className="pt-8 pb-12 md:pt-14 md:pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
...
//               >
//                 <span className="bg-[#0A1D3C] text-[#E8C673] border border-[#D4AF37]/80 px-4 py-1.5 rounded-full text-xs md:text-sm font-semibold tracking-widest uppercase shadow-sm ml-12">
//                   FAQ
//                 </span>
//               </motion.div>
...
//                 className="space-y-1 ml-12"
//               >
//                 <h1 className="text-5xl sm:text-6xl lg:text-[3.2rem] font-playfair font-bold text-[#0F2557] leading-tight">
//                   Frequently
//                 </h1>
//                 <h1 className="text-5xl sm:text-6xl lg:text-[3.2rem] font-playfair font-bold text-[#B8860B] gold-gradient-text leading-tight">
//                   Asked Questions
//                 </h1>
//               </motion.div>
...
//                 className="flex items-center space-x-3 max-w-xs ml-12"
//               >
//                 <div className="h-[1.5px] w-12 bg-gradient-to-r from-[#D4AF37] to-transparent flex-grow" />
//                 <span className="text-[#C69A43] text-lg select-none" aria-hidden="true">
//                   ✦
//                 </span>
//                 <div className="h-[1.5px] w-12 bg-gradient-to-l from-[#D4AF37] to-transparent flex-grow" />
//               </motion.div>
...
//                 className="text-base sm:text-lg md:text-xl text-[#334155] leading-relaxed max-w-lg font-normal ml-4"
//               >
...
//               >
//                 <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 border border-[#D4AF37]/30 text-[#0F2557] text-xs sm:text-sm font-medium shadow-xs">
//                   <Award className="w-4 h-4 text-[#C69A43]" />
//                   <span>UGC Entitled</span>
//                 </div>
//                 <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 border border-[#D4AF37]/30 text-[#0F2557] text-xs sm:text-sm font-medium shadow-xs">
//                   <GraduationCap className="w-4 h-4 text-[#C69A43]" />
//                   <span>NAAC A+ Universities</span>
//                 </div>
//                 <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 border border-[#D4AF37]/30 text-[#0F2557] text-xs sm:text-sm font-medium shadow-xs">
//                   <BookOpen className="w-4 h-4 text-[#C69A43]" />
//                   <span>100% Online Degrees</span>
//                 </div>
//               </motion.div>
//             </div>

//             {/* Right Column: 3D FAQ Clipboard Illustration */}
//             {/* <motion.div
...
//             >
//               <div className="absolute inset-0 bg-gradient-to-tr from-[#E3C67C]/20 to-[#0F2557]/10 rounded-full filter blur-3xl transform scale-90 -z-10" />

//               <div className="relative w-full max-w-xl mx-auto flex items-center justify-center">
//                 {!imageError ? (
//                   <Image
//                     src="/images/faq_hero_illustration.jpg"
//                     alt="FAQ 3D Clipboard with Graduation Cap, Books and Magnifying Glass on Gold Podium"
//                     width={600}
//                     height={460}
//                     className="w-full h-auto object-contain max-h-[460px] rounded-3xl drop-shadow-2xl hover:scale-[1.02] transition-transform duration-500"
//                     onError={() => setImageError(true)}
//                     priority
//                   />
//                 ) : (
//                   <div className="w-full aspect-4/3 max-w-[480px] bg-gradient-to-b from-white/90 to-[#F8F5EC] rounded-3xl border border-[#D4AF37]/40 shadow-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden">
//                     <div className="absolute top-4 right-4 bg-dots-pattern w-24 h-24 opacity-50" />
//                     <div className="absolute bottom-6 w-4/5 h-8 rounded-full bg-gradient-to-r from-[#DFBA6B] via-[#FFF3D1] to-[#DFBA6B] shadow-lg border-b-4 border-[#A37E30]" />
//                     <div className="relative z-10 w-48 h-64 bg-white rounded-2xl border-4 border-[#0F2557] shadow-xl p-4 flex flex-col items-center">
//                       <div className="w-16 h-4 bg-[#C69A43] rounded-t-md -mt-6 mb-3 border-2 border-[#0F2557]" />
//                       <span className="text-2xl font-bold font-playfair text-[#C69A43] tracking-widest mb-3">
//                         FAQ
//                       </span>
//                       <div className="w-full space-y-2.5">
//                         {[1, 2, 3, 4].map((item) => (
//                           <div key={item} className="flex items-center gap-2">
//                             <CheckCircle2 className="w-4 h-4 text-[#0F2557] shrink-0 fill-[#C69A43]/20" />
//                             <div className="h-2.5 bg-[#0F2557]/15 rounded w-full" />
//                           </div>
//                         ))}
//                       </div>
//                     </div>
//                     <div className="absolute bottom-12 left-10 z-20 flex flex-col items-center">
//                       <GraduationCap className="w-12 h-12 text-[#0F2557] -mb-2 z-30 drop-shadow-md" />
//                       <div className="w-24 h-6 bg-[#0F2557] rounded border border-[#C69A43] shadow-md" />
//                       <div className="w-26 h-6 bg-[#183979] rounded border border-[#C69A43] shadow-md -mt-1" />
//                       <div className="w-28 h-6 bg-[#0F2557] rounded border border-[#C69A43] shadow-md -mt-1" />
//                     </div>
//                     <div className="absolute bottom-10 right-10 z-20 transform rotate-12">
//                       <div className="w-16 h-16 rounded-full border-4 border-[#C69A43] bg-white/40 shadow-lg" />
//                       <div className="w-3 h-14 bg-[#0F2557] rounded-full mx-auto -mt-2 transform -rotate-45 origin-top" />
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//         <section id="faq" className="py-10 md:py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
...
//               <span className="text-[#C69A43] text-xs font-semibold select-none" aria-hidden="true">
//                 ✦
//               </span>
//               <span className="text-sm md:text-base font-bold font-playfair tracking-[0.2em] text-[#0F2557] uppercase">
//                 FAQ
//               </span>
//               <span className="text-[#C69A43] text-xs font-semibold select-none" aria-hidden="true">
//                 ✦
...
//             <h2 className="text-4xl sm:text-5xl lg:text-[3.25rem] font-playfair font-bold text-[#0F2557] tracking-tight">
...
//             <div className="w-16 h-0.5 bg-gradient-to-r from-[#DFBA6B] via-[#C29D4E] to-[#DFBA6B] mx-auto rounded-full mt-2" />
//           </div>

//           {/* Search & Category Filter Bar */}
//           <div className="mb-8 space-y-4">
//             <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white/80 backdrop-blur-sm p-3 rounded-2xl border border-[#D4AF37]/30 shadow-xs">
...
//                     className="w-full pl-9 pr-3 py-1.5 rounded-full text-xs sm:text-sm bg-[#F8F6F0] border border-amber-200/60 focus:outline-none focus:border-[#C69A43] focus:bg-white transition-colors"
//                   />
//                 </div>

//                 <div className="flex items-center gap-1 shrink-0 text-xs text-[#0F2557] font-medium">
//                   <button
//                     type="button"
//                     onClick={expandAll}
...
//               <div className="text-center py-12 bg-white/70 rounded-2xl border border-amber-200/50">
//                 <p className="text-lg text-slate-600 font-medium">No matching questions found.</p>
...
//                     setSearchQuery('');
//                   }}
//                   className="mt-4 px-4 py-1.5 rounded-full bg-[#0F2557] text-[#E8C673] text-sm font-semibold hover:bg-[#153472] transition-colors cursor-pointer"
//                 >
//                   Reset Filters
//                 </button>
//               </div>
...
//                     id={`faq-${item.id}`}
//                     initial={false}
//                     className={`group rounded-2xl transition-all duration-300 bg-white border ${
//                       isOpen
...
//                       className="w-full text-left px-5 sm:px-7 py-5 sm:py-6 flex items-center justify-between gap-4 sm:gap-6 cursor-pointer select-none"
//                       aria-expanded={isOpen}
//                     >
//                       <div className="flex items-center gap-4 sm:gap-5 flex-grow">
//                         {/* Number Badge */}
//                         <div
//                           className={`w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#0F2557] border-2 border-[#D4AF37] flex items-center justify-center shrink-0 shadow-sm transition-transform duration-300 ${
//                             isOpen ? 'scale-105 bg-[#0A1A3B]' : 'group-hover:scale-105'
//                           }`}
//                         >
//                           <span className="text-[#E8C673] font-cormorant text-lg sm:text-xl font-bold tracking-tight">
//                             {item.badgeNumber}
//                           </span>
//                         </div>
...
//                         {/* Question Title */}
//                         <span
//                           className={`font-cormorant font-bold text-xl sm:text-2xl leading-snug transition-colors ${
...
//                       >
//                         {isOpen ? (
//                           <Minus className="w-5 h-5 text-[#C69A43]" strokeWidth={2.5} />
//                         ) : (
//                           <Plus className="w-5 h-5 text-[#C69A43]" strokeWidth={2.5} />
//                         )}
//                       </div>
//                     </button>
...
//                         >
//                           <div className="px-5 sm:px-7 pb-6 pt-1 border-t border-amber-100/80 space-y-4">
//                             <p className="text-[#334155] text-base sm:text-lg leading-relaxed font-normal pt-2">
//                               {item.answer}
//                             </p>

//                             {/* Highlights list */}
//                             {item.highlights && item.highlights.length > 0 && (
//                               <div className="bg-[#FAF8F2] border border-amber-200/60 rounded-xl p-4 space-y-2">
//                                 <span className="text-xs font-bold uppercase tracking-wider text-[#0F2557] block mb-1">
//                                   Key Highlights
//                                 </span>
//                                 {item.highlights.map((highlight, idx) => (
//                                   <div
//                                     key={idx}
//                                     className="flex items-start gap-2.5 text-sm sm:text-base text-[#1E293B]"
//                                   >
//                                     <CheckCircle className="w-4 h-4 text-[#C69A43] shrink-0 mt-1 fill-[#C69A43]/15" />
//                                     <span>{highlight}</span>
//                                   </div>
//                                 ))}
//                               </div>
...
//                             {/* Feedback & Share Link */}
//                             <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-slate-100 text-xs sm:text-sm text-slate-500">
...
//                                 className="inline-flex items-center gap-1 text-slate-500 hover:text-[#0F2557] font-medium transition-colors cursor-pointer"
...
//         <section className="pt-4 pb-16 md:pb-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
//           <motion.div
//             initial={{ opacity: 0, y: 20 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             viewport={{ once: true }}
//             transition={{ duration: 0.6 }}
//             className="rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#FFFBF4] via-[#FAF6ED] to-[#FFFBF4] border border-[#E3CA8E]/80 shadow-[0_8px_30px_rgba(15,37,87,0.06)] p-6 sm:p-8 lg:p-10"
//           >
//             <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
//               <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-5 sm:gap-6 w-full lg:w-auto">
//                 <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#0F2557] border-2 border-[#D4AF37] flex items-center justify-center shrink-0 shadow-md">
//                   <GraduationCap className="w-9 h-9 sm:w-11 sm:h-11 text-[#E8C673]" />
//                 </div>
//                 <div className="space-y-1 sm:space-y-1.5 max-w-md">
//                   <h3 className="text-2xl sm:text-3xl font-playfair font-bold text-[#0F2557] tracking-tight">
...
//                   className="w-full sm:w-auto gold-btn-gradient text-[#0F2557] font-bold text-base sm:text-lg px-7 sm:px-8 py-3.5 sm:py-4 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-98 transition-all duration-200 inline-flex items-center justify-center gap-2 cursor-pointer border border-[#8C6B28]/20"
//                 >
...
//               className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-amber-200/80 overflow-hidden z-10"
//             >
//               <div className="bg-[#0F2557] px-6 sm:px-8 py-6 text-white relative">
//                 <button
//                   type="button"
//                   onClick={() => setIsModalOpen(false)}
//                   className="absolute top-5 right-5 text-slate-300 hover:text-white p-1 rounded-full hover:bg-white/10 transition-colors cursor-pointer"
//                 >
//                   <X className="w-5 h-5" />
//                 </button>
//                 <div className="flex items-center gap-3">
//                   <div className="w-10 h-10 rounded-full bg-[#D4AF37] text-[#0F2557] flex items-center justify-center shrink-0 font-bold">
...
//                     </div>
//                     <h4 className="text-2xl font-playfair font-bold text-[#0F2557]">
//                       Inquiry Received!
//                     </h4>
...
//                     </p>
//                     <div className="bg-[#FAF8F2] border border-amber-200/60 rounded-xl p-4 text-left text-xs sm:text-sm text-slate-700 space-y-1">
//                       <p>
...
//                       className="mt-2 w-full gold-btn-gradient text-[#0F2557] font-bold py-3 rounded-xl shadow-md hover:scale-[1.01] transition-transform cursor-pointer"
//                     >
//                       Close Window
//                     </button>
//                   </div>
...
//                     <div>
//                       <label className="block text-xs font-semibold uppercase tracking-wider text-[#0F2557] mb-1.5">
//                         Full Name *
//                       </label>
...
//                           }
//                           className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-[#C69A43] text-sm text-[#0F2557]"
//                         />
//                       </div>
//                     </div>
...
//                             })
//                           }
//                           className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-[#C69A43] text-sm text-[#0F2557] bg-white cursor-pointer"
//                         >
...
//                       className="w-full gold-btn-gradient text-[#0F2557] font-bold py-3.5 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-98 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer mt-2"
//                     >
//                       {isSubmitting ? (
